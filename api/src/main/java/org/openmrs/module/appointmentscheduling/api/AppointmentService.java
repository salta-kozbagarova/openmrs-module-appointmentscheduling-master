...
public interface AppointmentService extends OpenmrsService {
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_TYPES)
	List<PaymentType> getAllPaymentTypes(boolean includeRetired);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_TYPES)
    PaymentType getPaymentType(Integer paymentTypeId);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_TYPES)
    PaymentType getPaymentTypeByUuid(String uuid);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_TYPES)
	List<PaymentType> getPaymentTypes(String fuzzySearchPhrase);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_MANAGE_APPOINTMENT_TYPES)
    PaymentType retirePaymentType(PaymentType paymentType,
			String reason);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_MANAGE_APPOINTMENT_TYPES)
    PaymentType unretirePaymentType(PaymentType paymentType);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_MANAGE_APPOINTMENT_TYPES)
	void purgePaymentType(PaymentType paymentType);
	 ...
	 */
    @Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_TYPES)
	List<PaymentType> getAllPaymentTypesSorted(boolean includeRetired);
...
//	/**
//	 * Return a list of empty time slots that stands within the given constraints.
//	 *
//	 * @param appointmentType - Type of the appointment
//	 * @param fromDate - (optional) earliest start date. (defaults to current date)
//	 * @param toDate - (optional) latest start date.
...
//	 */
//	@Authorized(AppointmentUtils.PRIV_VIEW_APPOINTMENT_BLOCKS)
//	List<TimeSlot> getEmptyTimeSlotsByConstraints(AppointmentType appointmentType,
//											 Date fromDate, Date toDate, Provider provider, Location location,
//											 Patient excludeTimeSlotsWithPatient)
//			throws APIException;
